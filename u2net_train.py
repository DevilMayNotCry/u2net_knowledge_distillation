...
saved_model_dir = '/content/BEST_unetp.pth'
...
for epoch in range(0, epoch_num):
    ...
    for i, data in enumerate(salobj_dataloader):
        ...
        if ite_num % 200 == 0:
            ...
            torch.save(net.state_dict(), "/content/mod/itr_%d_train_%3f_tar_%3f_val_%3f_val_tar_%3f.pth" % (ite_num, running_loss / ite_num4val, running_tar_loss / ite_num4val, val_running_loss / val_ite_num4val, val_running_tar_loss / val_ite_num4val)) #!!!
